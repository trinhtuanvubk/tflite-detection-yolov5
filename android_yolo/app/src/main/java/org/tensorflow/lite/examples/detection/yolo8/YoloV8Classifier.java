...
//        d.imgData = ByteBuffer.allocateDirect(4915200);
        d.imgData = ByteBuffer.allocateDirect(1 * d.INPUT_SIZE * d.INPUT_SIZE * 3 * numBytesPerChannel);
        d.imgData.order(ByteOrder.nativeOrder());
        d.imgFloat = FloatBuffer.allocate(1 * d.INPUT_SIZE * d.INPUT_SIZE * 3 * numBytesPerChannel);
...
//        d.ANCHORS = anchors;
        ...
        int numClass = shape[shape.length - 2] - 4;
        d.numClass = numClass;
        d.outData = ByteBuffer.allocateDirect(8400 * (numClass + 4) * numBytesPerChannel);
...
//        FloatBuffer byteBuffer_ = convertBitmapToByteBuffer(bitmap);
...
//        Object[] inputArray = {imgFloat};
        ...
        Log.d("YoloV8Classifier", "out[0] detect start");
        ...
        Log.d("YoloV8Classifier", "detect end");
